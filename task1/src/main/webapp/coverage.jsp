...
<select  ng-model="unisured_underinsured_b_deductiblen">
<option >Select One</option>
<option value="">None</option>
<option value="150">$150</option>
<option value="200">$200</option>
...
<h5 ng-if="unisured_underinsured_b_deductiblen == 150"> Plan Details for Limit $1,00,000 </h5>
...
<h5 ng-if="unisured_underinsured_b_deductiblen == 200"> Plan Details for Limit $1,00,000 </h5>
...
<h5 ng-if="unisured_underinsured_b_deductiblen == 250"> Plan Details for Limit $1,00,000 </h5>
...
<h5 ng-if="unisured_underinsured_b_deductiblen == 350"> Plan Details for Limit $1,00,000 </h5>
...
<h5 ng-if="unisured_underinsured_b_deductiblen == 450"> Plan Details for Limit $1,00,000 </h5>
